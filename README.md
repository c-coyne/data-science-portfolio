...
This repository contains my portfolio of data science projects that I completed either for professional purposes or for self-development and education. I completed the strong majority of projects in Python using Jupyter Notebooks, but a few use other laguages (such as C++ / Arduino).
...
### Data Cleaning, Processing & Extracting
   ...
   - Aggregating & Writing CSV to XLSX (DOE input data): Python script that uses pandas and the xlsxwriter library to pull, clean, and write data from a variety of CSV files to a summary XLSX file.
